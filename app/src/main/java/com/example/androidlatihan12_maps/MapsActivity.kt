...
//        //mMap.addMarker(MarkerOptions().position(SARKOM).title("Intra Training Center"))
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(SARKOM, 17.0f))
//        mMap.mapType = GoogleMap.MAP_TYPE_NORMAL
//        val markerOptions = MarkerOptions().position(SARKOM)
//        markerOptions.icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(resources, R.mipmap.ic_car)))
